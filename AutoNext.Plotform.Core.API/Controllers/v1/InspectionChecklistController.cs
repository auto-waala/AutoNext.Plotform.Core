...
namespace AutoNext.Plotform.Core.API.Controllers
{
    [ApiController]
    [ApiVersion("1.0")]
    [Route("api/v{version:apiVersion}/inspection-checklist")]
    public class InspectionChecklistController : ControllerBase
    {
        private readonly IInspectionChecklistService _service;

        public InspectionChecklistController(IInspectionChecklistService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create(InspectionChecklistCreateDto dto)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(Guid id, InspectionChecklistUpdateDto dto)
        {
